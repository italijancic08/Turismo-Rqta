# Code-First Generation and Tooling

This reference covers advanced code-first workflows for generating OpenAPI specifications from application code, validating specifications, linting them, and generating SDKs.
