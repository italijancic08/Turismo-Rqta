...
When working on the Turismo Reconquista project:
...
- Keep compatibility with current browsers.
- Avoid introducing frameworks (React, Vue, Tailwind, Bootstrap) unless explicitly requested.
...
```
## Turismo Reconquista Breakpoints

Default breakpoint strategy for this project:
...
Use content-based breakpoints when necessary instead of adding unnecessary media queries.
...
## legacy Projects
For legacy projects or pages already using media queries,
introduce container queries gradually instead of replacing the existing responsive system.
