...
Public exported APIs are contracts.

Before changing an exported function, type, interface, constant or variable:

- Consider backwards compatibility.
- Prefer adding functionality over modifying behavior.
- Deprecate APIs before removing them.
- Keep deprecation periods documented.
...
Whenever a public API changes, update:
