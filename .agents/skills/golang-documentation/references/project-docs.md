...
Every project SHOULD document its directory layout.
...
Projects with multiple packages SHOULD include:
...
- Keep OpenAPI specifications synchronized.
...
Include a SECURITY.md file for public repositories.
...
- Dependencies require new setup
- Project structure changes

Documentation changes should be included in the same Pull Request as the implementation.

---

## AI-Friendly Documentation

Projects should be understandable by both humans and AI assistants.
