...
- The README can be followed by a new user.
- Installation instructions have been tested.
- Every code example compiles.
- Public APIs include usage examples.
- Breaking changes are documented.
- CHANGELOG is up to date.
- CONTRIBUTING reflects the current workflow.
- Documentation matches the current implementation.
- No comments contradict the source code.

Documentation is considered part of the implementation and should be reviewed with the same rigor as production code.
...
3. Examples over long explanations.
4. Maintainability over verbosity.
5. Readers first, writers second.

If code and documentation disagree, fix one of them immediately.