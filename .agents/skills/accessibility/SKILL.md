---
name: accessibility
description: Improve accessibility in Turismo Reconquista frontend using WCAG 2.2 guidelines. Use when modifying HTML, CSS, JavaScript, navigation, forms, images, responsive layouts, or UI components.
license: MIT
metadata:
  author: Turismo Reconquista
  version: "1.0"
---
