# modern-javascript-guide — detailed patterns and worked examples
...
//No crear Promises manualmente cuando ya trabajás con async/await o APIs que devuelven Promises (fetch, fs/promises, etc.).
