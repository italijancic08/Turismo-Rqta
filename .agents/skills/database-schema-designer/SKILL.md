...
description: Design robust, scalable database schemas for SQL and NoSQL databases. Provides normalization guidelines, indexing strategies, migration patterns, constraint design, and performance optimization. Optimized for MySQL, MariaDB and Node.js/Express applications, while remaining applicable to PostgreSQL and other SQL databases.
author: softaworks
version: "1.0"
license: MIT
---
