...
# Turismo-Rqta Database Conventions
...
- Evitar nombres abreviados

## Relaciones

- Todas las relaciones deben usar FOREIGN KEY.
- Definir ON DELETE y ON UPDATE según corresponda.

## Consultas

- Utilizar consultas parametrizadas con mysql2.
- Nunca concatenar datos enviados por el usuario.

## Índices

- Indexar todas las claves foráneas.
- Agregar índices en columnas utilizadas para búsquedas frecuentes.
